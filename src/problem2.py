...
def problem2a(triangle):
    ...
    # -------------------------------------------------------------------------
    triangle2 = Triangle(triangle.a, triangle.b, triangle.c)
    triangle2.a = triangle2.a * 2
    triangle2.b = triangle2.b * 2
    triangle2.c = triangle2.c * 2
    return triangle2
